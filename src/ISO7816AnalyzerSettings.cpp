...
ISO7816AnalyzerSettings::ISO7816AnalyzerSettings()
    : mChannelVCC( UNDEFINED_CHANNEL ), mChannelRST( UNDEFINED_CHANNEL ), mChannelCLK( UNDEFINED_CHANNEL ), mChannelIO( UNDEFINED_CHANNEL )
{
...
bool ISO7816AnalyzerSettings::SetSettingsFromInterfaces()
{
    ...
    Channel all_channels[ NUM_CHANNELS ] = { mChannelInterfaceVCC->GetChannel(), mChannelInterfaceRST->GetChannel(),
                                             mChannelInterfaceCLK->GetChannel(), mChannelInterfaceIO->GetChannel() };

    if( all_channels[ 1 ] == UNDEFINED_CHANNEL || all_channels[ 2 ] == UNDEFINED_CHANNEL || all_channels[ 3 ] == UNDEFINED_CHANNEL )
    {
